...
const PresetSearchScreen: React.FC<PresetSearchScreenProps> = ({
  ...
  const ownershipFilter = useAppPreferencesStore(
    (s) => s.presetSearchOwnershipFilter
  );
  const setOwnershipFilter = useAppPreferencesStore(
    (s) => s.setPresetSearchOwnershipFilter
  );
  ...
  const handleFirstExerciseSelected = useCallback(
    (exercise: Exercise) => {
          ...
          >
            <View className="flex-1">
              ...
              <Text className="text-sm mt-0.5" style={{ color: textSecondary }}>
                {t('workoutPresetCount', {
                  defaultValue: '{{formattedCount}} exercise',
                  count: item.exercises.length,
                  formattedCount: formatLocalizedNumber(item.exercises.length),
                })}
              </Text>
            </View>
          </TouchableOpacity>
        ...
        return (
          <StatusView
            {...ownershipFilterEmptyState({
              ...
              emptyTitle: t('presetSearch.noPresetsIn', {
      ...
      >
        ...
        <View className="flex-1 ml-3">
          <Text className="text-text-primary text-base font-medium">
            {t('presetSearch.emptyWorkout', { defaultValue: 'Empty workout' })}
          </Text>
          <Text className="text-sm mt-0.5" style={{ color: textSecondary }}>
            {t('presetSearch.pickFirstExercise', {
              defaultValue: 'Pick your first exercise',
            })}
          </Text>
        </View>
