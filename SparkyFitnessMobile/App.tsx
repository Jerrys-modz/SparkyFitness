...
/**
 * Unlike `WatchCheckInGate`, this stays subscribed while the server is
 * offline. Set completions are local (store + autosave), and HR batches
 * buffer until a flush can reach the API. Tearing the listeners down
